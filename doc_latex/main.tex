...
%%%%%%%%%%%%%%%% AMBIENTE PARA LISTAR HIPÓTESES %%%%%%%%%%%%%%%%
\usepackage{estilos/hipoteses}
...
%%%%%%%%%%%%%%%%%%%%% FICHA CATALOGRÁFICA %%%%%%%%%%%%%%%%%%%%%%
% \include{pre-textuais/ficha}

%%%%%%%%%%%%%%%%%%%%%% FOLHA DE APROVAÇÃO %%%%%%%%%%%%%%%%%%%%%%
% \include{pre-textuais/ata}
...
% \include{pre-textuais/abreviaturas}
% \cleardoublepage
% \begingroup
%     \makeatletter
%         \let\ps@plain\ps@empty
...
\include{sec/1_introducao}
\include{sec/2_fundamentação}
\include{sec/3_discussão}
\include{sec/4_conclusao}
...
% \include{pos-textuais/apendiceB}

%%%%%%%%%%%%%%%%%%%%%%%%%%%% ANEXOS %%%%%%%%%%%%%%%%%%%%%%%%%%%%
% \include{pos-textuais/anexoI}
